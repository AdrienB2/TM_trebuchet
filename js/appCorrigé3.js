...
const tmax = 90; // Temps maximal en seconde que la simulation peut durer (But: éviter un temps de calcul trop long)
...
function Resize() {
    ...
    if (Pause == true || SimulationStatus == false) {
        draw(angles[sauv - 1].a, angles[sauv - 1].b, angles[sauv - 1].c, {x: positionsx[sauv - 1], y: positionsy[sauv - 1]}, vitesses[sauv - 1], Energies[sauv - 1], sauv - 1, scale, xmin);
    }
}
